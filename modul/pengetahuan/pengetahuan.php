...
switch($_GET[act]){
  ...
  case "tambahpengetahuan":
	echo "	<div class='alert alert-success alert-dismissible'>
				...
				MD : Ukuran kenaikan ketidakpercayaan (measure of increased disbelief) <br> <br>
				<b>Contoh:</b><br>
				Jika kepercayaan <b>(MB)</b> anda terhadap gejala sakit kepala untuk jenis penyakit malaria tertiana adalah <b>0.4 (Mungkin)</b><br>
				Dan ketidakpercayaan <b>(MD)</b> anda terhadap gejala sakit kepala untuk jenis penyakit malaria tertiana adalah <b>0.2 (Hampir Mungkin)</b><br><br>
				<b>Maka:</b> CF(Pakar) = MB – MD (0.4 - 0.2) = <b>0.2</b> <br>
				Dimana nilai kepastian anda terhadap gejala sakit kepala untuk jenis penyakit malaria tertiana adalah <b>0.2 (Hampir Mungkin)</b>
              </div>
