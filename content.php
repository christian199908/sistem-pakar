...
}elseif ($module == "penjelasanPenyakit"){
include "modul/penPenyakit.php";
}elseif ($module == "penjelasanGejala"){
include "modul/penGejala.php";
}elseif ($module == "penjelasanPencegahan"){
include "modul/penPencegahan.php";
}
?>