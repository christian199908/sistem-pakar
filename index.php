...
<html><head>
    ...
    <base href="http://localhost/SP_pepaya/">
    ...
    <link rel="stylesheet" href="aset/skins/_all-skins.css">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b>K<i class="fa fa-adn"></i></b></span>
          <!-- <span class="logo-mini"></span> -->
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b style="text-transform: uppercase; letter-spacing: 2px">Sistem pakar<i class="fa fa-adn"></i></b></span>
        </a>
        <!-- Header Navbar -->
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Copyright © 2017 - Made with <i class="fa fa-heart pulse"></i> by <a href="#" target="_blank">kelompok 2 sistem pakar</a></div></strong>
      </footer>
